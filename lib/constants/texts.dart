class AppTexts {
  ...
  final String userName = "Update Username";
  ...
  final String map =
      "To get directions, tap the location marker and select Google Maps from the options below.";
  final String error="Oops there is problem login again";
}
